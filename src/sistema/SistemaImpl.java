...
public class SistemaImpl implements Sistema {
	...
	private PriceStrategy obtenerStrategy(PlataformaStreaming plataforma) {
		...
		if (plataforma instanceof Netflix) {
			return new StrategyNetflix();
		}
		if (plataforma instanceof DisneyPlus) {
			return new StrategyDisney();
		}
		if (plataforma instanceof PrimeVideo) {
			return new StrategyPrime();
		}
